            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="resources/img/customer-1.jpg" alt="Customer picture">Alberto Duncan</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        Inexpensive, healthy and great-tasting meals, delivered right to my home. We have lots of food delivery here in Lisbon, but no one comes even close to Omifood. Me and my family are so in love!
                        <cite><img src="resources/img/customer-2.jpg" alt="Customer picture">Joana Silva</cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        I was looking for a quick and easy food delivery service in San Franciso. I tried a lot of them and ended up with Omnifood. Best food delivery service in the Bay Area. Keep up the great work!
                        <cite><img src="resources/img/customer-3.jpg" alt="Customer picture">Milton Chapman</cite>
                    </blockquote>
                </div>
            </div>
            ...
            <div class="row">
                <form method="post" action="mailer.php" class="contact-form">
                    <div class="row form-messages">
                        <!-- Commented out PHP code for an .html file to allow the full functionalities of JS
                             code: mainly scroll animations and scroll-to functions. Due to GitHub Pages not
                             supporting PHP and altering the performance of site. -->
<!--
                        <?php
